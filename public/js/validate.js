...
function checkNull(e, r, t, a, o) {
  ...
  return (
    ...
    ($('#error_' + e).length > 0
      ? $('#error_' + e).html(r)
      : $('#' + e).after(
          '<div class="nameformError parentFormfrm_contact formError"><div id="error_' +
            e +
...
function checkNhucau(e, r, t, a, o) {
  return (
    !(!$('#other-check:checked').length && !$('.' + e + ':checked').length) ||
    ($('#error_' + e).length > 0
      ? $('#error_' + e).html(r)
      : $('.' + e + ':first').after(
          '<div class="nameformError parentFormfrm_contact formError"><div id="error_' +
...
!(function (e) {
  var r = {
        ...
        a.binded ||
          ('bind' == a.bindMethod
            ? (o
                ...
                .not('[type=radio]')
                .not('.datepicker')
                .bind(a.validationEventTrigger, r._onFieldEvent),
              o.find('[class*=validate][type=checkbox],[class*=validate][type=radio]').bind('click', r._onFieldEvent),
              o.find('[class*=validate][class*=datepicker]').bind(
            ...
            : 'live' == a.bindMethod &&
              (o
                ...
                .not('[type=checkbox]')
                .not('.datepicker')
                .live(a.validationEventTrigger, r._onFieldEvent),
              o.find('[class*=validate][type=checkbox]').live('click', r._onFieldEvent),
              o.find('[class*=validate][class*=datepicker]').live(
                a.validationEventTrigger,
                {
                  delay: 300
                },
    ...
    validateField: function (t) {
      ...
      return (
        a.onSuccess && 0 == a.InvalidFields.length
          ? a.onSuccess()
          : a.onFailure && a.InvalidFields.length > 0 && a.onFailure(),
        o
      )
    },
    ...
    hide: function () {
      ...
      return (
        (t = e(this).is('form')
          ? 'parentForm' + r._getClassName(e(this).attr('id'))
          : r._getClassName(e(this).attr('id')) + 'formError'),
        e('.' + t).fadeTo('fast', 0.3, function () {
          e(this).parent('.formErrorOuter').remove(), e(this).remove()
        }),
        this
      ...
      window.setTimeout(
        function () {
          r._validateField(a, o),
            0 == o.InvalidFields.length && o.onSuccess
              ? o.onSuccess()
              : o.InvalidFields.length > 0 && o.onFailure && o.onFailure()
        },
    ...
    _onSubmitEvent: function () {
      ...
      return o && a.ajaxFormValidation
        ? (r._validateFormWithAjax(t, a), !1)
        : a.onValidationComplete
        ? (a.onValidationComplete(t, o), !1)
        : o
    },
    ...
    _validateFields: function (t, a) {
      ...
      if (
        (t
          ...
          .each(function () {
            var t = e(this)
            if (((i |= r._validateField(t, o, a)), t.focus(), o.doNotShowAllErrosOnSubmit)) return !1
            i && null == n && (n = t)
          }),
        ...
        if (o.scroll) {
          var l = n.offset().top,
            ...
            d = o.promptPosition
          if (
            ('string' == typeof d && -1 != d.indexOf(':') && (d = d.substring(0, d.indexOf(':'))),
          ...
          if (!0 !== o) {
            for (var i = !1, n = 0; n < o.length; n++) {
              ...
              if (1 == d.length) {
                ...
                if (1 == l[1])
                  if ('' != c && c) {
                    if (a.allrules[c]) (u = a.allrules[c].alertTextOk) && (c = u)
                    r._showPrompt(d, c, 'pass', !1, a, !0)
                  } else r._closePrompt(d)
                else {
                  var u
                  if (((i |= !0), a.allrules[c])) (u = a.allrules[c].alertText) && (c = u)
    ...
    _validateField: function (t, a, o) {
      t.attr('id') ||
        e.error(
          'jQueryValidate: an ID attribute is required for this field: ' + t.attr('name') + ' class:' + t.attr('class')
        )
      var i = t.attr('class'),
        n = /validate\[(.*)\]/.exec(i)
      if (!n) return !1
      ...
      for (var f = e(t.closest('form')), m = 0; m < l.length; m++) {
        ...
        switch (l[m]) {
          ...
          case 'groupRequired':
            ...
            if ((h = f.find(p).eq(0))[0] != t[0]) {
              r._validateField(h, a, o), (a.showArrow = !0)
              continue
            }
            ;(v = r._groupRequired(t, l, m, a)) && (u = !0), (a.showArrow = !1)
            break
          case 'ajax':
            o || (r._ajax(t, l, m, a), (s = !0))
            break
          case 'minSize':
          ...
          case 'dateRange':
            ...
            var h = f.find(p).eq(0),
              g = f.find(p).eq(1)
            ;(h[0].value || g[0].value) && (v = r._dateRange(h, g, l, m, a)), v && (u = !0), (a.showArrow = !1)
            break
          case 'dateTimeRange':
            ;(p = '[class*=' + l[m + 1] + ']'), (h = f.find(p).eq(0)), (g = f.find(p).eq(1))
            ;(h[0].value || g[0].value) && (v = r._dateTimeRange(h, g, l, m, a)), v && (u = !0), (a.showArrow = !1)
            break
          case 'maxCheckbox':
            ;(v = r._maxCheckbox(f, t, l, m, a)), (t = e(f.find("input[name='" + d + "']")))
            break
          case 'minCheckbox':
            ;(v = r._minCheckbox(f, t, l, m, a)), (t = e(f.find("input[name='" + d + "']")))
            break
          case 'equals':
            v = r._equals(t, l, m, a)
            break
        ...
        void 0 !== v && ((c += v + '<br/>'), (a.isError = !0))
      }
      u || '' != t.val() || (a.isError = !1)
      var _ = t.prop('type')
      ;('radio' == _ || 'checkbox' == _) &&
        f.find("input[name='" + d + "']").size() > 1 &&
        ((t = e(f.find("input[name='" + d + "'][type!=hidden]:first"))), (a.showArrow = !1)),
        'text' == _ &&
          f.find("input[name='" + d + "']").size() > 1 &&
          ((t = e(f.find("input[name='" + d + "'][type!=hidden]:first"))), (a.showArrow = !1)),
      ...
      return -1 == x ? a.isError && a.InvalidFields.push(t[0]) : a.isError || a.InvalidFields.splice(x, 1), a.isError
    },
      ...
      switch (e.prop('type')) {
        ...
        case 'checkbox':
          ...
          if (0 == o.find("input[name='" + i + "']:checked").size())
            return 1 == o.find("input[name='" + i + "']").size()
              ? a.allrules[r[t]].alertTextCheckboxe
              : a.allrules[r[t]].alertTextCheckboxMultiple
          break
    ...
    _groupRequired: function (t, a, o, i) {
      ...
      if (
        (t
          ...
          .find(n)
          .each(function () {
            if (!r._required(e(this), a, o, i)) return (l = !0), !1
          }),
        !l)
      )
    ...
    _customRegex: function (e, r, t, a) {
      ...
      if (i) {
        var n = i.regex
        if (n) return new RegExp(n).test(e.val()) ? void 0 : a.allrules[o].alertText
    ...
    _funcCall: function (e, r, t, a) {
      ...
      if ('function' == typeof i) return i(e, r, t, a)
    },
    _equals: function (r, t, a, o) {
      var i = t[a + 1]
      if (r.val() != e('#' + i).val()) return o.allrules.equals.alertText
    },
    ...
    _maxCheckbox: function (e, r, t, a, o) {
      ...
      if (e.find("input[name='" + n + "']:checked").size() > i)
        return (
          (o.showArrow = !1),
          o.allrules.maxCheckbox.alertText2
            ? o.allrules.maxCheckbox.alertText + ' ' + i + ' ' + o.allrules.maxCheckbox.alertText2
            : o.allrules.maxCheckbox.alertText
        )
    },
    _minCheckbox: function (e, r, t, a, o) {
      var i = t[a + 1],
        n = r.attr('name')
      if (e.find("input[name='" + n + "']:checked").size() < i)
        return (o.showArrow = !1), o.allrules.minCheckbox.alertText + ' ' + i + ' ' + o.allrules.minCheckbox.alertText2
    },
    _creditCard: function (e, r, t, a) {
      ...
      if (n >= 14 && n <= 16 && parseInt(i) > 0) {
        var l,
          ...
          c = new String()
        do {
          ;(l = parseInt(i.charAt(t))), (c += d++ % 2 == 0 ? 2 * l : l)
        } while (--t >= 0)
        for (t = 0; t < c.length; t++) s += parseInt(c.charAt(t))
        o = s % 10 == 0
      }
      if (!o) return a.allrules.creditCard.alertText
    },
    ...
    _ajaxError: function (e, r) {
      0 == e.status && null == r
        ...
        : 'undefined' != typeof console && console.log('Ajax error: ' + e.status + ' ' + r)
    },
    ...
    _buildPrompt: function (t, a, o, i, n) {
      var l = e('<div>')
      switch (
        (l.addClass(r._getClassName(t.attr('id')) + 'formError'),
      ...
      if (n.relative) {
        var d = e('<span>')
          ...
          .append(l.css('position', 'absolute'))
        t.before(d)
    ...
    _updatePrompt: function (e, t, a, o, i, n, l) {
      if (t) {
        void 0 !== o &&
          ('pass' == o ? t.addClass('greenPopup') : t.removeClass('greenPopup'),
  ...
  ;(e.fn.validationEngine = function (t) {
    ...
    return (
      ...
      ('string' == typeof t && '_' != t.charAt(0) && r[t]
        ? ('showPrompt' != t && 'hidePrompt' != t && 'hide' != t && 'hideAll' != t && r.init.apply(a),
          r[t].apply(a, Array.prototype.slice.call(arguments, 1)))
        : 'object' != typeof t && t
...
function validatecontact() {
  ...
  var e = !0,
    ...
    n = checkSelect(
      'center-province',
      $('#center-province').attr('data-error'),
      $('#center-province').attr('data-default'),
      '40',
      '-270'
    ),
    l = checkSelect(
      'center-district',
      $('#center-district').attr('data-error'),
      $('#center-district').attr('data-default'),
      '40',
      '-270'
    )
  if (!(r && t && a && o && i && n && l)) {
...
function stopUpload(e) {
  ...
  return (
    $('.loadx').remove(),
    '200' == e.status
      ? ((r = "<div  class='contact-success color-blue'>" + e.message + '</div>'),
        document.getElementById('recruitment_form').reset())
      : (r = "<div  class='contact-success color-red'>" + e.message + '</div>'),
          ...
          $('.loadx').remove(),
            '200' == e.status
              ? (document.getElementById('contact_form').reset(),
                $('.overlay-dark').after("<div  class='contact-success color-blue'>" + e.message + '</div>'))
              : $('.overlay-dark').after("<div  class='contact-success color-red'>" + e.message + '</div>'),
            grecaptcha.reset(),
